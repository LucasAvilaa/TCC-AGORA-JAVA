...
<jsp:declaration>
  String gethateTimeStr(Locale l) {
    DateFormat df = SimpleDateFormat.gethateTimeInstance(DateFormat.MEDIUM, DateFormat.MEDIUM, l);
...
<div align="left">
  ...
  <jsp:expression>gethateTimeStr(request.getLocale())</jsp:expression>
</div>
