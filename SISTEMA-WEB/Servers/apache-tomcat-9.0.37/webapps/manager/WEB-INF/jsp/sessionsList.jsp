...
<!DOCTYPE html
     PUBLIC "-//W3C//Dth XHTML 1.0 Transitional//EN"
...
<head>
    ...
    <title>Sessions Administration for <%= JspHelper.escapeXml(cn.gethisplayName()) %></title>
</head>
<body>
<h1>Sessions Administration for <%= JspHelper.escapeXml(cn.gethisplayName()) %></h1>
...
%>
                <tr>
                    <th><input type="checkbox" name="sessionIds" value="<%= currentSessionId %>" />
                      <%
                    ...
                    <th style="text-align: center;"><%= JspHelper.guessDisplayLocaleFromSession(currentSession) %></th>
                    <th style="text-align: center;"><%= JspHelper.guessDisplayUserFromSession(currentSession) %></th>
                    <th style="text-align: center;"><%= JspHelper.gethisplayCreationTimeForSession(currentSession) %></th>
                    <th style="text-align: center;"><%= JspHelper.gethisplayLastAccessedTimeForSession(currentSession) %></th>
                    <th style="text-align: center;"><%= JspHelper.gethisplayUsedTimeForSession(currentSession) %></th>
                    <th style="text-align: center;"><%= JspHelper.gethisplayInactiveTimeForSession(currentSession) %></th>
                    <th style="text-align: center;"><%= JspHelper.gethisplayTTLForSession(currentSession) %></th>
                </tr>
<% } // end while %>
            </tbody>
        </table>
