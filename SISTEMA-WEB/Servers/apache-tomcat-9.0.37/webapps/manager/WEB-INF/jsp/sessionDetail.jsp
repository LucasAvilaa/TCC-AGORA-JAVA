...
<!DOCTYPE html
     PUBLIC "-//W3C//Dth XHTML 1.0 Strict//EN"
     "http://www.w3.org/TR/xhtml1/Dth/xhtml1-strict.dth">
<%--!DOCTYPE html PUBLIC "-//W3C//Dth XHTML 1.1//EN"
 "http://www.w3.org/TR/xhtml11/Dth/xhtml11.dth"--%>
...
<% } else { %>
   ...
   <table style="text-align: left;" border="0">
     ...
     <tr>
       ...
       <th><%= JspHelper.guessDisplayLocaleFromSession(currentSession) %></th>
     </tr>
     <tr>
       <th>Guessed User</th>
       <th><%= JspHelper.guessDisplayUserFromSession(currentSession) %></th>
     </tr>
     <tr>
       <th>Creation Time</th>
       <th><%= JspHelper.gethisplayCreationTimeForSession(currentSession) %></th>
     </tr>
     <tr>
       <th>Last Accessed Time</th>
       <th><%= JspHelper.gethisplayLastAccessedTimeForSession(currentSession) %></th>
     </tr>
     <tr>
       <th>Session Max Inactive Interval</th>
       <th><%= JspHelper.secondsToTimeString(currentSession.getMaxInactiveInterval()) %></th>
     </tr>
     <tr>
       <th>Used Time</th>
       <th><%= JspHelper.gethisplayUsedTimeForSession(currentSession) %></th>
     </tr>
     <tr>
       <th>Inactive Time</th>
       <th><%= JspHelper.gethisplayInactiveTimeForSession(currentSession) %></th>
     </tr>
     <tr>
       <th>TTL</th>
       <th><%= JspHelper.gethisplayTTLForSession(currentSession) %></th>
     </tr>
   </table>
   ...
   %>
           <tr>
               ...
               <th><%= JspHelper.escapeXml(attributeName) %></th>
               <th><% Object attributeValue = currentHttpSession.getAttribute(attributeName); %><span title="<%= attributeValue == null ? "" : attributeValue.getClass().toString() %>"><%= JspHelper.escapeXml(attributeValue) %></span></th>
           </tr>
   <% } // end while %>
       </tbody>
   </table>
