...
request.setAttribute("tomcathocUrl", "/docs/");
    ...
    <body>
        <div id="wrapper">
            <div id="navigation" class="curved container">
                ...
                <span id="nav-hosts"><a href="${tomcathocUrl}">Documentation</a></span>
                <span id="nav-config"><a href="${tomcathocUrl}config/">Configuration</a></span>
            ...
            <div id="upper" class="curved container">
                ...
                <div id="notice">
                    ...
                    <div id="tasks">
                        ...
                        <h4><a href="${tomcathocUrl}security-howto.html">Security Considerations How-To</a></h4>
                        <h4><a href="${tomcathocUrl}manager-howto.html">Manager Application How-To</a></h4>
                        <h4><a href="${tomcathocUrl}cluster-howto.html">Clustering/Session Replication How-To</a></h4>
                    </div>
                </div>
                <div id="actions">
                    <div class="button">
            ...
            <div id="middle" class="curved container">
                ...
                <div class="col25">
                    <div class="container">
                        <p><a href="${tomcathocUrl}setup.html">Tomcat Setup</a></p>
                        <p><a href="${tomcathocUrl}appdev/">First Web Application</a></p>
                    </div>
                </div>
                <div class="col25">
                    <div class="container">
                        <p><a href="${tomcathocUrl}realm-howto.html">Realms &amp; AAA</a></p>
                        <p><a href="${tomcathocUrl}jndi-datasource-examples-howto.html">JDBC DataSources</a></p>
                    </div>
                </div>
                <div class="col25">
                    <div class="container">
            ...
            <div id="lower">
                <div id="low-manage" class="">
                    <div class="curved container">
                        ...
                        <p>In Tomcat 9.0 access to the manager application is split between
                           different users. &nbsp; <a href="${tomcathocUrl}manager-howto.html">Read more...</a></p>
                        <br />
                        <h4><a href="${tomcathocUrl}RELEASE-NOTES.txt">Release Notes</a></h4>
                        <h4><a href="${tomcathocUrl}changelog.html">Changelog</a></h4>
                ...
                <div id="low-docs" class="">
                    <div class="curved container">
                        <h3>Documentation</h3>
                        <h4><a href="${tomcathocUrl}">Tomcat 9.0 Documentation</a></h4>
                        <h4><a href="${tomcathocUrl}config/">Tomcat 9.0 Configuration</a></h4>
                        ...
                        <ul>
                            ...
                            <li><a href="${tomcathocUrl}api/index.html">Tomcat 9.0 JavaDocs</a></li>
                ...
                <div class="col20">
                    <div class="container">
                        ...
                        <ul>
                            ...
                            <li><a href="${tomcathocUrl}deployer-howto.html">Deployer</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col20">
