		...
		<tbody>
			 <c:forEach items="${cliente}" var="cliente">
				<tr> 
					...
					<td><a href='ControlCliente?action=edit&idCli=<c:out value="${cliente.idCli}"/>'><img src="img/refresh-icon.png" style="width: 21px; height: 21px; "></a></td>
					<td><a href='ControlCliente?action=delete&idCli=<c:out value="${cliente.idCli}"/>'><img src="img/delete.png" style="width: 21px; height: 21px; "></a></td>				
				</tr> 
			</c:forEach>
		</tbody>		
	</table>	
