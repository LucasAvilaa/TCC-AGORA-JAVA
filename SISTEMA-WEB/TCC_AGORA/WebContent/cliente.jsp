...
<html>
	...
	<f:view>
		...
		<fieldset id="informacoes">
			...
			<p>NOME: <input name="nome"  maxlength="50" value="<c:out value="${cliente.nome}"/>" required="required" style="width: 362px; "/></p> 
			<p>SOBRENOME: <input name="sobrenome" maxlength="50" value="<c:out value="${cliente.sobrenome}"/>" required="required" style="width: 311px; "/></p>
			<p>CPF: <input name="cpf" maxlength="14"value="<c:out value="${cliente.cpf}"/>" placeholder="xxx.xxx.xxx-xx" required="required" style="width: 163px; "/>
			   RG: <input name="rg" maxlength="12" value="<c:out value="${cliente.rg}"/>" placeholder="xx.xxx.xxx-x"  required="required" style="width: 168px; "/></p>
			<p>NASCIMENTO: <input name="data" type="date" value="<fmt:formatDate pattern="dd/MM/yyyy" value="${cliente.dtNasc}"/>"  maxlength="10" placeholder="dd/mm/yyyy" required="required" style="width: 139px; ">  
			   SEXO: <h:selectOneMenu style="width: 96px; height: 24px" id="sexo">				
