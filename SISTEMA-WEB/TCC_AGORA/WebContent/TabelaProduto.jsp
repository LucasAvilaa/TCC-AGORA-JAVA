            ...
            <tbody>
               <c:forEach items="${produto}" var="produto">
                  <tr>
                     ...
                     <td><a href='ControlProduto?action=Edit&idProd=<c:out value="${produto.idProduto}"/>'><button class="btn btn-success" style="height: 2.2em; width: 8em;">EDITAR <img src="img/edit.svg" style="width: 21px; height: 21px; " title="EDITAR" /></button></a></td>
