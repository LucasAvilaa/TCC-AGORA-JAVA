...
<html>
	...
	<f:view>
		...
		<fieldset id="informacoes">
			...
			<p><label>RAZÃO SOCIAL: <input name="razao-social"  maxlength="50" value="<c:out value="${fornecedor.razaoSocial}"/>" required="required" style="width: 364px; "/></label></p> 
	 		<p><label>CNPJ: <input name="cnpj" id="cnpj" value="<c:out value="${fornecedor.cnpj}"/>" placeholder="xxx.xxx.xxx-xx" required="required" style="width: 163px; "/></label>
