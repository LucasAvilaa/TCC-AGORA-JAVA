 ...
 *
 * @author Pablo Alexander da Rocha Gon莽alves
 */
public class ViaCEP extends ViaCEPBase {
    ...
    /**
     * Constr贸i uma nova classe e busca um CEP no ViaCEP
     *
     * @param events eventos para a classe
     * @param cep
    ...
    public final void buscar(String cep) throws ViaCEPException {
        ...
        if (!obj.has("erro")) {
            ...
            throw new ViaCEPException("N胦 foi possivel encontrar o CEP", cep, ViaCEPException.class.getName());
        }
    }
    
    /**
     * Busca um CEP usando um endere莽o
     *
        ...
        if (ceps.length() > 0) {
            for (int i = 0; i < ceps.length(); i++) {
                ...
                if (!obj.has("erro")) {
                    ...
                    throw new ViaCEPException("N胦 foi possivel validar o CEP", currentCEP, ViaCEPException.class.getName());
                }
            }
        } else {
