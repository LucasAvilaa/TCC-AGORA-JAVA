...
AS
	BEGIN
		DECLARE @ID_GERAL INT = (SELECT DBO.PROCURA_ID_GERAL('?'))
			IF(@ACAO = 'I') -- INSERIR
				BEGIN
...
>>>>>>> master
	...
	INSERT INTO TB_CLIENTES VALUES (NEWID(), 'OTÁVIO','LUIZ NICOLAS CORTE REAL','28.792.065-3','763.327.498-06','19/05/1994', 'M', NULL,1,GETDATE())
	INSERT INTO TB_CLIENTES VALUES (NEWID(), 'BRENDA','MIRELLA SILVA','14.068.796-8','671.226.233-00','05/01/2000', 'F', NULL,1, GETDATE())
	INSERT INTO TB_CLIENTES VALUES (NEWID(), 'THOMAS','KAIQUE ARTHUR DA CRUZ','42.880.242-4','193.171.433-93','20/02/1964', 'M', NULL,1, GETDATE())
...
SELECT
   -- NEWID() AS STRING_ALEATORIO,
    CHECKSUM(NEWID()) AS INTEIRO_ALEATORIO
	 ...
	 EXEC PROC_CRUD_CLIENTE "I","LUCAS","AVILA","00601650","050640054","06/07/2002",'M',1
*/