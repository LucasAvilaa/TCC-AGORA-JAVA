...
AS 	
	BEGIN 	
		...
		WHILE @@FETCH_STATUS = 0
			...
			INSERT INTO TB_CONTAS_PAGAR	VALUES(@ID_COMPRA, @DESCRICAO,@CATEGORIA, @VALOR_PAGAR,GETDATE() + 30)		
	 END 
GO	 
...
GO	 
  SELECT SUM(SUBTOTAL) AS TOTAL FROM VW_COMPRA WHERE ID_COMPRA = 1002
/*
