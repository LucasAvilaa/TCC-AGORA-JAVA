...
CREATE TABLE TB_PRODUTOS(
    ...
    VALOR_UNI_COMPRA DECIMAL(7,2),
    VALOR_UNI_VENDA DECIMAL(7,2), 
	DATA_CADASTRO DATETIME,
...
AS 	
	BEGIN 	
		...
		DECLARE @VALOR_PAGAR DECIMAL(7,2)  = (SELECT SUM(SUBTOTAL) AS TOTAL 
											  FROM VW_COMPRA
											  WHERE ID_COMPRA = @ID_COMPRA)
...
AS
	...
	FROM  TB_COMPRA_PRODUTO LISTA
		...
		INNER JOIN TB_FORNECEDORES FORNECEDORES ON FORNECEDORES.ID_FORN = PRODUTO.ID_FORN_PROD
GO	
...
SELECT TOP 1 *  FROM TB_COMPRAS ORDER BY ID_COMPRA DESC
...
EXEC PROC_COMPRA_ESTAB EC,1001,NULL,NULL 
	...
	SELECT * FROM VW_COMPRA WHERE ID_COMPRA = 1055 AND ID_PRODUTO = 1000
