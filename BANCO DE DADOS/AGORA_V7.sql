...
CREATE TABLE TB_COMANDA(
	...
	STATUS_COMANDA CHAR(1) DEFAULT 'D'-- ATIVO(A)  DESATIVADO(D) PAGO(P) 
);
...
CREATE TABLE TB_CONTAS_RECEBER(
	...
	METODO_PAGAMENTO VARCHAR(2), --CREDITO(CR), DINHEIRO(DI), DEBITO(DE) 
...
CREATE TABLE TB_COMPRAS(
    ...
    STATUS CHAR(1), --COTACAO(C), CONFIRMADO(P), FINALIZADO(F)
...
/*   
	INSERT INTO TB_FORNECEDORES VALUES (NEWID(), 'COCA-COLA OFICIAL','80.700.511/0001-89', GETDATE()) 

	INSERT INTO TB_PRODUTOS (NOME_PRODUTO, DESCRICAO_PRODUTO, CATEGORIA, VALOR_UNI_COMPRA, VALOR_UNI_VENDA, DATA_CADASTRO) VALUES ('COCA-COLA 2L', NULL, 'REFRIGERANTE', 5,8, GETDATE() )
	INSERT INTO TB_PRODUTOS (NOME_PRODUTO, DESCRICAO_PRODUTO, CATEGORIA, VALOR_UNI_COMPRA, VALOR_UNI_VENDA, DATA_CADASTRO) VALUES ('FARINHA 20K', 'FARINHA SEARA TIPO 2 20K - SEM GLUTEN', 'FARINHA', 50.60, NULL,GETDATE() )
	INSERT INTO TB_PRODUTOS (NOME_PRODUTO, DESCRICAO_PRODUTO, CATEGORIA, VALOR_UNI_COMPRA, VALOR_UNI_VENDA, DATA_CADASTRO) VALUES ('DORITOS 720G', NULL, 'SALGADINHOS', 9, 12.98,GETDATE() )
