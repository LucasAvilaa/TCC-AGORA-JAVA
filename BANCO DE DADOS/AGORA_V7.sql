...
SELECT * FROM VW_COMPRA_TOTAL
SELECT * FROM VW_CONTAS_PAGAR  
SELECT * FROM VW_END_CONTATO
...
*/ 
	...
	SELECT ID_PRODUTO, NOME_PRODUTO, MIN(QUANTIDADE) 
	FROM VW_ESTOQUE
	WHERE VALOR_VENDA IS NOT NULL AND QUANTIDADE > 0 AND VALOR_VENDA > 0
	GROUP BY ID_PRODUTO, NOME_PRODUTO  
	
 SELECT * FROM VW_ESTOQUE ORDER BY NOME_PRODUTO, QUANTIDADE DESC

 SELECT MIN(QUANTIDADE) FROM VW_ESTOQUE WHERE ID_PRODUTO = 1000 AND QUANTIDADE > 0