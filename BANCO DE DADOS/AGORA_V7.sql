...
BEGIN
		IF(@ACAO = 'I')
			BEGIN
				INSERT INTO TB_CONTAS_PAGAR VALUES(@ID_COMPRA, @CATEGORIA ,@VALOR_PAGAR,@DATA_VENCIMENTO) 
			END
...
AS 	
	BEGIN 	
		...
		WHILE @@FETCH_STATUS = 0
			...
			INSERT INTO TB_CONTAS_PAGAR	VALUES(@ID_COMPRA, @CATEGORIA,@VALOR_PAGAR ,GETDATE() + 30)		
	 END 
GO	 
