...
EXEC PROC_COMPRA_ESTAB EC,1001,NULL,NULL 
	...
	SELECT * FROM VW_COMPRA 
	SELECT SUM(SUBTOTAL) FROM VW_COMPRA AS TOTAL
...
SELECT * FROM VW_CONTAS_PAGAR  
 ...
 SELECT  CONVERT(INT, CRYPT_GEN_RANDOM(4)) AS MEU_PREFERIDO_SQL2012

SELECT (DATEPART(NS, SYSDATETIME()))		

SELECT -- NEWID() AS STRING_ALEATORIO,  CHECKSUM(NEWID()) AS INTEIRO_ALEATORIO 
*/ 