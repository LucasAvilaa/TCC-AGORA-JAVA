...
GO	 
  SELECT SUM(SUBTOTAL) AS TOTAL FROM VW_COMPRA WHERE ID_COMPRA = 1012
...
EXEC PROC_COMPRA_ESTAB EC,1001,NULL,NULL 
	...
	EXEC PROC_VENDA_ESTAB 'I',4480, 1, 500,NULL, NULL, NULL, NULL
	EXEC PROC_VENDA_ESTAB 'I',4480, 2, 100,NULL, NULL, NULL, NULL
	EXEC PROC_VENDA_ESTAB 'I',4480, 3, 200,NULL, NULL, NULL, NULL
	...
	INSERT INTO TB_FUNCIONARIOS VALUES (NEWID(), 'GIOVANA','BRUNA ISADORA SILVEIRA', '49.052.192-7','104.911.713-15','24/06/1976', 'F', 'ADMINISTRADOR',NULL,1,GETDATE())
	INSERT INTO TB_FUNCIONARIOS VALUES (NEWID(), 'FABIO','EMANUEL LIMA','17.153.772-5','524.546.303-20','11/08/1981', 'M','GERENTE',NULL,1,GETDATE())
