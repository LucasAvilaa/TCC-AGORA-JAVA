...
DROP PROCEDURE PROC_CRUD_ESTOQUE
	@ACAO VARCHAR(1),
	@ID_ESTOQUE INT,
	@ID_PRODUTO INT, 
	@QUANTIDADE INT,  
...
AS
	SELECT COMPRA.ID_COMPRA, 
		   ...
		   QUANTIDADE,
		   PRODUTO.VALOR_UNI_COMPRA,
		   DATA_C

	FROM TB_COMPRAS COMPRA
		INNER JOIN TB_CONTAS_PAGAR PAGAR ON PAGAR.ID_COMPRA = COMPRA.ID_COMPRA
...
SELECT * FROM VW_COMPRA WHERE ID_COMPRA = ?
SELECT * FROM TB_COMPRA_PRODUTO

	SELECT * FROM TB_COMPRAS WHERE ID_COMPRA = 1009
/*
	----------------------------
	...
	EXEC PROC_COMPRA_ESTAB II,1009,1003,200 
	EXEC PROC_COMPRA_ESTAB C,1009,NULL,NULL 
